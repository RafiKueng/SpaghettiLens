...
DATABASES = {
    'default': {
        ...
        'NAME': '../database/lmt.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'l7((=i4g=n8ti8(ok@$!gv+@v4+q&amp;!z97anfb&amp;qcq^33c4au_@'
...
MIDDLEWARE_CLASSES = (
    ...
    #'lmt.ProcessExceptionMiddleware',
    'lmt.ProcessExceptionMiddleware.ProcessExceptionMiddleware',
)
