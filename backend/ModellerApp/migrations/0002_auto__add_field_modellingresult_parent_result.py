...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModellingResult.parent_result'
        db.add_column('ModellerApp_modellingresult', 'parent_result',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='child_results', null=True, blank=True, to=orm['ModellerApp.ModellingResult']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModellingResult.parent_result'
        db.delete_column('ModellerApp_modellingresult', 'parent_result_id')
    ...
    models = {
        ...
        'ModellerApp.modellingresult': {
            ...
            'parent_result': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'child_results'", 'null': 'True', 'blank': 'True', 'to': "orm['ModellerApp.ModellingResult']"}),
