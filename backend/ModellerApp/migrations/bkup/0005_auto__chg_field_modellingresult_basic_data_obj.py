...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModellingResult.basic_data_obj'
        db.alter_column('ModellerApp_modellingresult', 'basic_data_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ModellerApp.BasicLensData'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ModellingResult.basic_data_obj'
        raise RuntimeError("Cannot reverse this migration. 'ModellingResult.basic_data_obj' and its values cannot be restored.")
    ...
    models = {
        ...
        'ModellerApp.modellingresult': {
            ...
            'basic_data_obj': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ModellerApp.BasicLensData']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'created_by_str': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
