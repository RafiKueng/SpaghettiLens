...
out = {
    ...
    var that = LMT.ui.out; 
        ...
        */
        ...
        $("#btnOutGlassConfig").on('click', function(){
        ...
        $("#btnOutGraphics").on('click', function(){
            $.event.trigger($btn.data("event"));
        });
    ...
    load: function(evt) {
        ...
        */
        ...
        for (var i=0;i<newSimImgs.length;i++){
            if (typeof(newSimImgs[i])=='undefined') {
                newSimImgs.splice(i, 1);
            }
        }
