...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModellingResult.created_by_str'
        db.add_column('ModellerApp_modellingresult', 'created_by_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Collection.created_by'
        db.add_column('ModellerApp_collection', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Collection.created_by_str'
        db.add_column('ModellerApp_collection', 'created_by_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'LensData.created_by_str'
        db.add_column('ModellerApp_lensdata', 'created_by_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModellingResult.created_by_str'
        db.delete_column('ModellerApp_modellingresult', 'created_by_str')

        # Deleting field 'Collection.created_by'
        db.delete_column('ModellerApp_collection', 'created_by_id')

        # Deleting field 'Collection.created_by_str'
        db.delete_column('ModellerApp_collection', 'created_by_str')

        # Deleting field 'LensData.created_by_str'
        db.delete_column('ModellerApp_lensdata', 'created_by_str')
